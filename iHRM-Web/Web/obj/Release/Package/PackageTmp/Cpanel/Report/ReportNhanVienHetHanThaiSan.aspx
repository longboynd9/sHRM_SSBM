<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportNhanVienHetHanThaiSan.aspx.cs" Inherits="iHRM.WebPC.Cpanel.Report.ReportNhanVienHetHanThaiSan" %>
            ...
            <Reader>
                <ext:JsonReader IDProperty="id">
                    <Fields>
                        ...
                        <ext:RecordField Name="tuNgay" Type="Date" />
                        <ext:RecordField Name="denNgay" Type="Date" />
                    </Fields>
                </ext:JsonReader>
            </Reader>
        </ext:Store>
                ...
                <ext:GridPanel
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server">
                            <Items>
                                ...
                                <ext:DateField ID="txtDate" HideLabel="true" runat="server" Format="MM/yyyy" Width="95">
                                    <Plugins>
                                        <ext:MonthPicker runat="server" />
                                    </Plugins>
                                </ext:DateField>
                                <ext:Label runat="server" Text="Số ngày: " />
                                <ext:NumberField ID="txtSoNgay" runat="server" Width="55" />
                    ...
                    <ColumnModel runat="server">
                        <Columns>
                            ...
                            <ext:DateColumn Header="Ngày bắt đầu" DataIndex="tuNgay" Width="100" Format="dd/MM/yyyy"></ext:DateColumn>
                            <ext:DateColumn Header="Ngày kết thúc" DataIndex="denNgay" Width="100" Format="dd/MM/yyyy"></ext:DateColumn>
                        </Columns>
                    </ColumnModel>
                    <View>
                        <ext:GroupingView
