<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportNhanVienDuoi18Tuoi.aspx.cs" Inherits="iHRM.WebPC.Cpanel.Report.ReportNhanVienDuoi18Tuoi" %>
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout">
            <Items>
                <ext:GridPanel
                    ...
                    StripeRows="true"
                    AutoScroll="true"
                    Title="Báo cáo nhân viên dưới 18 tuổi"
                    Collapsible="true"
                    AnimCollapse="true"
