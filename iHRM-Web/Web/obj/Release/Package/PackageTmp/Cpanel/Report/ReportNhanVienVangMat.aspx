<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportNhanVienVangMat.aspx.cs" Inherits="iHRM.WebPC.Cpanel.Report.ReportNhanVienVangMat" %>
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout">
            <Items>
                <ext:GridPanel
                    ...
                    StripeRows="true"
                    AutoScroll="true"
                    Title="Báo cáo nhân viên vắng mặt"
                    Collapsible="true"
                    AnimCollapse="true"
                    ...
                    <ColumnModel runat="server">
                        <Columns>
                            ...
                            <ext:Column Header="Loại nghỉ" DataIndex="lydo" Width="100"></ext:Column>
