<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportHopDongHetHan.aspx.cs" Inherits="iHRM.WebPC.Cpanel.Report.ReportHopDongHetHan" %>
                ...
                <ext:GridPanel
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server">
                            <Items>
                                ...
                                <ext:Checkbox Id="chkHdCuoi" runat="server" BoxLabel="Hợp đồng cuối cùng" BoxLabelStyle="size:18" />
                    ...
                    <ColumnModel runat="server">
                        <Columns>
                            ...
                            <ext:Column Header="Loại hợp đồng" DataIndex="ContractTypeName" Width="100"></ext:Column>
                            <ext:DateColumn Header="Ngày bắt đầu" DataIndex="BeginDate" Width="100" Format="dd/MM/yyyy"></ext:DateColumn>
                            <ext:DateColumn Header="Ngày kết thúc" DataIndex="EndDate" Width="100" Format="dd/MM/yyyy"></ext:DateColumn>
                        </Columns>
                    </ColumnModel>
                    <View>
                        <ext:GroupingView
