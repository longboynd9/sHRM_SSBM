<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DKCaLam.aspx.cs" Inherits="iHRM.WebPC.Cpanel.QuetThe.DKCaLam" %>
...
<body>
    <form id="form1" runat="server">
        <div>
                ...
                <Items>
                    ...
                    <ext:Panel runat="server" Region="West" Border="false" Collapsible="true" Split="true" Width="170" Layout="FormLayout"
                        ...
                        <Items>
                            ...
                            <ext:DateField ID="txtTuNgay" runat="server" FieldLabel="#QuetThe_DKCaLam.lbTuNgay" AnchorHorizontal="100%" Format="dd/MM/yyyy"></ext:DateField>
                            <ext:DateField ID="txtDenNgay" runat="server" FieldLabel="#QuetThe_DKCaLam.lbDenNgay" AnchorHorizontal="100%" Format="dd/MM/yyyy"></ext:DateField>
                    ...
                    <ext:GridPanel ID="GridPanel1" runat="server" Border="false" StoreID="Store1" Region="Center">
                        ...
                        <ColumnModel>
                            <Columns>
                                ...
                                <ext:Column Header="HSL" DataIndex="heSoLuong" />
                ...
                <Items>
                    <ext:FormPanel ID="frmEditor" runat="server" Layout="FormLayout" Padding="10" Border="false">
                        <Items>
                            ...
                            <ext:CompositeField runat="server">
                                <Items>
                                    <ext:DateField ID="txtTuNgay2" runat="server" FieldLabel="#QuetThe_DKCaLam.lbTuNgay" Format="dd/MM/yyyy" AnchorHorizontal="100%" AllowBlank="false" Flex="1" />
                                    <ext:Label runat="server" Text="#QuetThe_DKCaLam.lbDenNgay" />
                                    <ext:DateField ID="txtDenNgay2" runat="server" FieldLabel="" Format="dd/MM/yyyy" AnchorHorizontal="100%" AllowBlank="false" Flex="1" />
                                </Items>
                            </ext:CompositeField>

                            <ext:ComboBox ID="cmbCaLam" runat="server" FieldLabel="#QuetThe_DKCaLam.lamca" DisplayField="ten" ValueField="id" AnchorHorizontal="100%" AllowBlank="false" StoreID="stoCaLam" Editable="false" />
                            <ext:Checkbox FieldLabel="Reg Sunday 200%" ID="chkRegSunday" runat="server" Checked="false" />
                    </Items>
                </ext:FormPanel>
                </Items>
                <Buttons>
                ...
                <Items>
                    <ext:FormPanel ID="FormPanel1" runat="server" Layout="FormLayout" Padding="10" Border="false">
                        <Items>
                            ...
                            <ext:CompositeField runat="server">
                                <Items>
                                    <ext:DateField ID="dateTuNgay" runat="server" FieldLabel="#QuetThe_DKCaLam.lbTuNgay" Format="dd/MM/yyyy" AnchorHorizontal="100%" AllowBlank="false" Flex="1" />
                                    <ext:Label runat="server" Text="#QuetThe_DKCaLam.lbDenNgay" />
                                    <ext:DateField ID="dateDenNgay" runat="server" FieldLabel="" Format="dd/MM/yyyy" AnchorHorizontal="100%" AllowBlank="false" Flex="1" />
                                </Items>
                            </ext:CompositeField>
                            ...
                            <ext:Checkbox FieldLabel="Reg Sunday 200%" ID="chkRegSunday2" runat="server" Checked="false" />
                        </Items>
                    </ext:FormPanel>
                </Items>
                <Buttons>
            ...
            <ext:Window ID="WdkNhom1" runat="server" Layout="FitLayout" Width="450" Height="220" Title="Đăng ký theo nhóm" Icon="RecordGreen" Hidden="true">
                <Items>
                    <ext:FormPanel ID="FormPanel2" runat="server" Layout="FormLayout" Padding="10" Border="false">
                        <Items>
                            <ext:ComboBox ID="cmbNhom1" runat="server" FieldLabel="Nhóm 1" Editable="false" DisplayField="gName" ValueField="id" AnchorHorizontal="100%">
                                <Store>
                            ...
                            <ext:CompositeField runat="server">
                                <Items>
                                    <ext:DateField ID="dateTuNgay3" runat="server" FieldLabel="#QuetThe_DKCaLam.lbTuNgay" Format="dd/MM/yyyy" Flex="1" AllowBlank="false" />
                                    <ext:Label runat="server" Text="#QuetThe_DKCaLam.lbDenNgay" />
                                    <ext:DateField ID="dateDenNgay3" runat="server" FieldLabel="" Format="dd/MM/yyyy" Flex="1" AllowBlank="false" />
                                </Items>
                            </ext:CompositeField>
                            ...
                            <ext:Checkbox FieldLabel="Reg Sunday 200%" ID="chkRegSunday3" runat="server" Checked="false" />
                        </Items>
                    </ext:FormPanel>
                </Items>
                <Buttons>
