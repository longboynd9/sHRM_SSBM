<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DKNghiKoLuong.aspx.cs" Inherits="iHRM.WebPC.Cpanel.QuetThe.DKNghiKoLuong" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function grd_cmd(cmdName, record, rowIdx, colIdx) {
            if (cmdName == 'Edit') {
                OpenEditor(record.id, '#QuetThe_DKNghiKhongLuong.msg_js2' + record.id);
            }
                ...
                return confirm("#QuetThe_DKNghiKhongLuong.msg_js3");
            }
        }
...
<body>
    <form id="form1" runat="server">
        <div>
                        ...
                        <TopBar>
                            <ext:Toolbar runat="server">
                                <Items>
                                    ...
                                    <ext:Button runat="server" Text="#QuetThe_DKNghiKhongLuong.DKCaNhan" Icon="Add">
                                        <Listeners>
                                            <Click Handler="#{editor}.show(); #{txtNhanVien}.setValue(#{txtSearchKey}.getValue());" />
                                        </Listeners>
                                    </ext:Button>
                                    <ext:Button runat="server" Text="#QuetThe_DKNghiKhongLuong.DKTapThe" Icon="Add">
                                        <Listeners>
            ...
            <ext:Window ID="editor" runat="server" Layout="FitLayout" Width="450" Height="290" Title="#QuetThe_DKNghiKhongLuong.titleDKNKL" Icon="RecordBlue" Hidden="true">
                <Items>
                    <ext:FormPanel ID="frmEditor" runat="server" Layout="FormLayout" Padding="10" Border="false">
                        <Items>
                            <ext:CompositeField runat="server" AnchorHorizontal="100%">
                                <Items>
                                    <ext:TextField ID="txtNhanVien" runat="server" FieldLabel="Mã NV" Width="120" AllowBlank="false" MaxLength="15" MaskRe="[^<>&amp;*]" IndicatorIcon="Information" IndicatorTip="EmployeeID" EnableKeyEvents="true">
                                        <Listeners>
                            ...
                            <ext:TextField ID="txtNhanVien2" runat="server" FieldLabel="#QuetThe_DKNghiKhongLuong.nv" AnchorHorizontal="100%" ReadOnly="true" />
                                                        
                            <ext:CompositeField runat="server" AnchorHorizontal="100%">
                                <Items>
                                    <ext:DateField ID="txtNgayDK" runat="server" FieldLabel="#QuetThe_DKNghiKhongLuong.ngay" Format="dd/MM/yyyy" AllowBlank="false" Flex="1">
                                        <DirectEvents>
                                            <Change OnEvent="txtNgayDK_DirectSelect" />
                                        </DirectEvents>
                                    </ext:DateField>
                                    <ext:Label runat="server" Text="#QuetThe_DKNghiKhongLuong.denNgay" Cls="cc1" />
                            ...
                            <ext:ComboBox ID="cmbLyDo" runat="server" FieldLabel="#QuetThe_DKNghiKhongLuong.lbLyDo" DisplayField="ten" ValueField="id" AnchorHorizontal="100%" 
                                AllowBlank="false" StoreID="stoLyDo" Editable="false">
                            </ext:ComboBox>
                            <ext:TextArea ID="txtGhiChu" runat="server" FieldLabel="#QuetThe_DKNghiKhongLuong.lbGhiChu" AnchorHorizontal="100%" Height="45" />
                        </Items>
                    </ext:FormPanel>
                </Items>
                <Buttons>
                    <ext:Button ID="btnDangKy" runat="server" Text="#QuetThe_DKNghiKhongLuong.dangky">
                        <Listeners>
                            <Click Handler="if (!#{frmEditor}.getForm().isValid()){Ext.Msg.show({icon: Ext.MessageBox.ERROR, msg: '#QuetThe_DKNghiKhongLuong.msg_js', buttons:Ext.Msg.OK}); return false;}" />
                        </Listeners>
                        <DirectEvents>
            ...
            <ext:Window ID="WdkTapThe" runat="server" Layout="FitLayout" Width="450" Height="260" Title="#QuetThe_DKNghiKhongLuong.titleDKTapThe" Icon="RecordBlue" Hidden="true">
                <Items>
                    <ext:FormPanel ID="FormPanel1" runat="server" Layout="FormLayout" Padding="10" Border="false">
                        <Items>
                            <ext:CompositeField runat="server" AnchorHorizontal="100%">
                                <Items>
                                    <ext:TextField ID="txtMaTo" runat="server" FieldLabel="#QuetThe_DKNghiKhongLuong.CodeTapThe" Width="100" AllowBlank="false" MaxLength="15" MaskRe="[^<>&amp;*]" EnableKeyEvents="true">
                                        <Listeners>
                                            <KeyDown Fn="txtMa_KeyDown2" />
                                        </Listeners>
                                    </ext:TextField>
                                    <ext:Button ID="btnTim" runat="server" Text="#common_btn_FindOne" OnDirectClick="btnTim_TapThe" />
                                </Items>
                            </ext:CompositeField>
                            <ext:TextField ID="txtTo" runat="server" FieldLabel="#QuetThe_DKNghiKhongLuong.to" AnchorHorizontal="100%" AllowBlank="false" MaxLength="100" ReadOnly="true"/>

                            <ext:CompositeField runat="server" AnchorHorizontal="100%">
                                <Items>
                                    <ext:DateField ID="txtNgayDK2" runat="server" FieldLabel="#QuetThe_DKNghiKhongLuong.ngay" Format="dd/MM/yyyy" AllowBlank="false" Flex="1" />
                                    <ext:Label runat="server" Text="#QuetThe_DKNghiKhongLuong.denNgay" Cls="cc1" />
                            ...
                            <ext:ComboBox ID="cmbLyDo2" runat="server" FieldLabel="#QuetThe_DKNghiKhongLuong.lbLyDo" DisplayField="ten" ValueField="id" AnchorHorizontal="100%" 
                                AllowBlank="false" StoreID="stoLyDo" Editable="false">
                            </ext:ComboBox>
                            <ext:TextArea ID="txtGhiChu2" runat="server" FieldLabel="#QuetThe_DKNghiKhongLuong.lbGhiChu" AnchorHorizontal="100%" Height="45" />
                        </Items>
                    </ext:FormPanel>
                </Items>
                <Buttons>
                    <ext:Button ID="Button1" runat="server" Text="#QuetThe_DKNghiKhongLuong.dangky">
                        <Listeners>
                            <Click Handler="if (!#{FormPanel1}.getForm().isValid()){Ext.Msg.show({icon: Ext.MessageBox.ERROR, msg: '#QuetThe_DKNghiKhongLuong.msg_js', buttons:Ext.Msg.OK}); return false;}" />
                        </Listeners>
                        <DirectEvents>
                ...
                <Items>
                    <ext:FormPanel ID="FormPanel2" runat="server" Layout="FormLayout" Padding="10" Border="false">
                        <Items>
                            ...
                            <ext:CompositeField runat="server">
                                <Items>
                                    <ext:ComboBox FieldLabel="Xin nghỉ" runat="server" ID="cmbXinNghi3" Editable="false" Width="120">
                                        <Items>
                                            <ext:ListItem Text="Buổi sáng" Value="1" />
                                            <ext:ListItem Text="Buổi Chiều" Value="2" />
                                            <ext:ListItem Text="Cả ngày" Value="3" />
