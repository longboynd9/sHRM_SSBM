<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportLuongSP.aspx.cs" Inherits="iHRM.WebPC.Cpanel.Luong.ImportLuongSP" %>
...
<body>
    <form id="form1" runat="server">
        <div>
                    ...
                    <ext:GridPanel ID="GridPanel1" runat="server" Border="false" StoreID="Store1" Region="Center">
                        ...
                        <ColumnModel>
                            <Columns>
                                ...
                                <ext:NumberColumn Header="Lương SP" DataIndex="LuongSP" Format="0,0" />
            ...
            <ext:Window ID="editor" runat="server" Layout="FitLayout" Width="450" Height="180" Title="#Luong_ImportTsTinhLuong.dkCN" Icon="RecordBlue" Hidden="true">
                <Items>
                    <ext:FormPanel ID="frmEditor" runat="server" Layout="FormLayout" Padding="10" Border="false">
                        <Items>
                            ...
                            <ext:DateField ID="txtThangImport" runat="server" FieldLabel="#Luong_ImportTsTinhLuong.thang" Width="100" Format="MM/yyyy" AllowBlank="false">
                                <Plugins>
                                    <ext:MonthPicker runat="server" />
                                </Plugins>
                            </ext:DateField>

                            <ext:NumberField ID="txtLuongSP" runat="server" FieldLabel="Lương SP" AnchorHorizontal="100%" />
            ...
            <ext:Window ID="WdkTapThe" runat="server" Layout="FitLayout" Width="450" Height="180" Title="#Luong_ImportTsTinhLuong.dkTH" Icon="RecordBlue" Hidden="true">
                <Items>
                    <ext:FormPanel ID="FormPanel1" runat="server" Layout="FormLayout" Padding="10" Border="false">
                        <Items>
                            ...
                            <ext:DateField ID="txtThangImport2" runat="server" FieldLabel="#Luong_ImportTsTinhLuong.thang" Width="100" Format="MM/yyyy" AllowBlank="false">
                                <Plugins>
                                    <ext:MonthPicker runat="server" />
                                </Plugins>
                            </ext:DateField>
                            
                            <ext:NumberField ID="txtLuongSP2" runat="server" FieldLabel="Lương SP" AnchorHorizontal="100%" />
                        </Items>
                    </ext:FormPanel>
                </Items>
                <Buttons>
