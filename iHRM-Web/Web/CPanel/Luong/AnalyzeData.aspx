<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnalyzeData.aspx.cs" Inherits="iHRM.WebPC.Cpanel.Luong.AnalyzeData" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Viewport ID="Viewport1" runat="server" Layout="BorderLayout" HideBorders="true" AutoScroll="true">
                <Items>
                    <ext:Panel runat="server" Region="North" Border="false" LabelWidth="50" Height="85" Layout="FormLayout" Padding="10">
                        <Items>
                            <ext:Label runat="server" HideLabel="true" Text="#Luong_AnalyzeData.lblNote" />

                            <ext:CompositeField runat="server" HideLabel="true">
                                <Items>
                                    <ext:Label runat="server" Text="#Luong_AnalyzeData.lbTuNgay" />
                                    <ext:DateField ID="txtDate1" runat="server" Format="dd/MM/yyyy" />
                                    <ext:Label runat="server" Text="#Luong_AnalyzeData.lbDenNgay" />
                                    <ext:DateField ID="txtDate2" runat="server" Format="dd/MM/yyyy" />

                                    <ext:Label runat="server" Text="Làm tròn" />
                                    <ext:Checkbox ID="chkLamTron" runat="server" FieldLabel="" />
                                </Items>
                            </ext:CompositeField>
