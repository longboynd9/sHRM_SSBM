...
{
    public partial class ReportNhanVienHetHanThaiSan : BackEndPageBase
    {
        ...
        protected void Search(object sender, DirectEventArgs e)
        {
            ...
            data = logic.GetReportNVHetHanNghiThaiSan(txtDate.SelectedDate, "", Convert.ToInt32(txtSoNgay.Value));
            ...
            {
                Store1.DataSource = data;// data.AsEnumerable().OrderBy(p => p["DepName"]).CopyToDataTable()
                Store1.DataBind();
            }
        }
