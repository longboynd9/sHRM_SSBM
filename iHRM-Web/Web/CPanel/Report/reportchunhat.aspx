<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reportchunhat.aspx.cs" Inherits="iHRM.WebPC.Cpanel.Report.reportchunhat" %>
            ...
            <Reader>
                <ext:JsonReader IDProperty="id">
                    <Fields>
                        ...
                        <ext:RecordField Name="tgTinhTangCa"/><ext:RecordField Name="tong"/>
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout">
            <Items>
                <ext:GridPanel
                    ...
                    StripeRows="true"
                    AutoScroll="true"
                    Title="Thống kê nhân viên làm chủ nhật"
                    Collapsible="true"
                    AnimCollapse="true"
                    ...
                    <ColumnModel runat="server">
                        <Columns>
                            ...
                            <ext:DateColumn Header="Ngày vào" DataIndex="AppliedDate" Width="70" Format="dd/MM/yyyy"  Align="Center"></ext:DateColumn>
                            <ext:DateColumn Header="Ngày Làm CN" DataIndex="ngay" Width="80" Format="dd/MM/yyyy" Align="Center"></ext:DateColumn>
                            <ext:Column Header="Số giờ Làm" DataIndex="tong" Width="75"  Align="Center"></ext:Column>
