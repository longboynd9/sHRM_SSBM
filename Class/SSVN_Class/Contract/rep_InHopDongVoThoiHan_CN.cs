...
{
    public partial class rep_InHopDongVoThoiHan_CN : DevExpress.XtraReports.UI.XtraReport
    {
        dcDatabaseDataContext db = new dcDatabaseDataContext(Provider.ConnectionString);
        public rep_InHopDongVoThoiHan_CN()
        {
            InitializeComponent();
        ...
        public void BindingData(object dt) 
        {
            ...
            lbQuocTich.DataBindings.Add("Text", bindingSource1, "NationalityName_VIE");
