    ...
    public class TinhLuongHelper_1dong
    {
        ...
        public TinhLuongHelper_1dong(dsTinhLuong ds, DateTime tuNgay, DateTime denNgay, string EmployeeID)
        {
            ...
            if (luongMoi == null)
            {
                ...
                {
                    _Luong1Ngay = (DbHelper.DrGetDouble(kq1, "BasicSalary") + DbHelper.DrGetDouble(kq1, "BasicSalary_Ins")) / _soNgayCongTrongThang;
                }
            }
            else
            {
        ...
        public double TinhTienNgayCong(int type = 0, bool tinhLuongCu = false, bool tinhCaDem = false)
        {
            ...
            if (type == 1 && (_kq.tt_leTet > 0 || _kq.tt_chuNhat))
                return 0;
            if (type == 4 && !_kq.tt_chuNhat)// Nếu tính chủ nhật mà trạng thái tt_chuNhat == false
                return 0;
            if (tinhCaDem)
            {
                if (_kq.caDem)
                {
                    ...
                    {
                        double ngayCong = TinhNgayCong(type, tinhLuongCu, true);
                        if (_kq.tt_leTet == 1)
                        {
        ...
        public double TinhGioTangCa(int type = 0, bool tinhLuongCu = false, bool tinhCaDem = false)
        {
            ...
            if (type == 3) //le tet
            {
                ...
                {
                    if (_kq.kqNgayCong > 0)
                        return _kq.kqNgayCong * 8 + tgTinhTangCa;
                    else
                        return 0;
                }
            }
        ...
        public double TinhThuongBuaToi(bool tinhLuongCu = false)
        {
            if (_LaLuongCu != tinhLuongCu)
                return 0;
            double tgTinhTangCa = _kq["tgTinhTangCa"] == DBNull.Value ? 0 : _kq.tgTinhTangCa;
        ...
        public double TinhTienTangCa(int type = 0, bool tinhLuongCu = false, bool tinhCaDem = false)
        {
            ...
            if (type == 3) //le tet
            {
                ...
                else
                {
                    if (_kq.kqNgayCong > 0)
                    {
                        tgTinhTangCa = tgTinhTangCa + (_kq.kqNgayCong * 8);
                        ...
                        else
                        {
                            if (tinhLuongCu)
                            {
                                return _LuongTungNgay / 8 * tgTinhTangCa * _kq.heSoLuong / 100;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        foreach (var it in lstTinhTC)
                        {
                            ...
                            {
                                if (tinhLuongCu)
                                    sum += soTieng * _LuongTungNgay / 8 * _kq.heSoLuong / 100; //fixed / 8
                                else
                                    sum += soTieng * _LuongTungNgay / 8 * _kq.heSoLuong / 100; //fixed / 8
                            }
