            ...
            try
            {
                ...
                foreach (string eID in lstEmp)
                {
                    try
                    {
                        ...
                        r.ngaycong_bt = r.tienNC_bt = r.ngaycong_phep = r.tienNC_phep = r.ngaycong_phepNam = r.tienNC_phepNam = r.ngaycong_lt = r.tienNC_lt = r.ngaycong_cn = r.tienNC_cn = r.tongNgayCong = r.tienNgayCong = r.thuongLamCa = r.thuongBuaToi = r.ngayCong_Dem = r.tienNC_Dem = 0;
                        r.tgTangCa_bt = r.tienTangCa_bt = r.tgTangCa_cn = r.tienTangCa_cn = r.tgTangCa_lt = r.tienTangCa_lt = r.tongThoiGianTangCa = r.tienTangCa = r.tgTangCa_Dem = r.tienTangCa_Dem = 0;

                        r2.ngaycong_bt = r2.tienNC_bt = r2.ngaycong_phep = r2.tienNC_phep = r2.ngaycong_phepNam = r2.tienNC_phepNam = r2.ngaycong_lt = r2.tienNC_lt = r2.ngaycong_cn = r2.tienNC_cn = r2.tongNgayCong = r2.tienNgayCong = r2.thuongLamCa = r2.thuongBuaToi = r2.ngayCong_Dem = r2.tienNC_Dem = 0;
                        r2.tgTangCa_bt = r2.tienTangCa_bt = r2.tgTangCa_cn = r2.tienTangCa_cn = r2.tgTangCa_lt = r2.tienTangCa_lt = r2.tongThoiGianTangCa = r2.tienTangCa = r2.tgTangCa_Dem = r2.tienTangCa_Dem = 0;
                        ...
                        foreach (var kq in kqs)
                        {
                            ...
                            r.ngayCong_Dem += hp.TinhNgayCong(1, tinhCaDem: true);
                            r.tienNC_Dem += hp.TinhTienNgayCong(1, tinhCaDem: true);

                            r.ngaycong_phep += hp.TinhNgayCong(2);
                            r.tienNC_phep += hp.TinhTienNgayCong(2);
                            r.tienNC_phep += hp.TinhTienNgayCong(2,tinhCaDem:true);

                            f = hp.TinhNgayCong(5);
                            r.ngaycong_phepNam += f;
                            r.tienNC_phepNam += hp.TinhTienNgayCong(5);
                            r.tienNC_phepNam += hp.TinhTienNgayCong(5,tinhCaDem:true);

                            r.ngaycong_lt += hp.TinhNgayCong(3);
                            r.tienNC_lt += hp.TinhTienNgayCong(3);
                            r.tienNC_lt += hp.TinhTienNgayCong(3, tinhCaDem: true);

                            f = hp.TinhNgayCong(4);
                            r.ngaycong_cn += f;
                            r.tongTgTangCa_cn_gio += f * kq.soTiengTinhCa;
                            r.tienNC_cn += hp.TinhTienNgayCong(4);
                            r.tienNC_cn += hp.TinhTienNgayCong(4, tinhCaDem: true);
                            #endregion
                            ...
                            r.tgTangCa_Dem += hp.TinhGioTangCa(1, tinhCaDem: true);
                            r.tienTangCa_Dem += hp.TinhTienTangCa(1, tinhCaDem: true);

                            f = hp.TinhGioTangCa(2);
                            r.tgTangCa_cn += f;
                            r.tongTgTangCa_cn_gio += f;
                            r.tienTangCa_cn += hp.TinhTienTangCa(2);
                            r.tienTangCa_cn += hp.TinhTienTangCa(2, tinhCaDem: true);

                            r.tgTangCa_lt += hp.TinhGioTangCa(3);
                            r.tienTangCa_lt += hp.TinhTienTangCa(3);
                            r.tienTangCa_lt += hp.TinhTienTangCa(3, tinhCaDem: true);
                            #endregion

                            #region tinh thưởng bữa tối theo lương mới.(ca Hành chính SX: 7h30 - 16h30 )
                            var a = hp.TinhThuongBuaToi(ds, r, 10);
                            r.thuongBuaToi += a;
                            #endregion

                            #region tinh thưởng làm ca chiều theo lương mới.( 14h00 - 22h00 )
                            if (kq.tuGio >= new TimeSpan(12, 0, 0) && kq.denGio == new TimeSpan(8, 0, 0) && !kq.IskqNgayCongNull() && kq.kqNgayCong > 0 && !kq.caDem)
                            {
                                r.thuongLamCa += 20000;
                            }
                            #endregion
                            if (hp.luongCu != null)
                            {
                                ...
                                r2.ngayCong_Dem += hp.TinhNgayCong(1, true, tinhCaDem: true);
                                r2.tienNC_Dem += hp.TinhTienNgayCong(1, true, tinhCaDem: true);

                                r2.ngaycong_phep += hp.TinhNgayCong(2, true);
                                r2.tienNC_phep += hp.TinhTienNgayCong(2, true);
                                r2.tienNC_phep += hp.TinhTienNgayCong(2, true, tinhCaDem: true);

                                r2.ngaycong_phepNam += hp.TinhNgayCong(5, true);
                                r2.tienNC_phepNam += hp.TinhTienNgayCong(5, true);
                                r2.tienNC_phepNam += hp.TinhTienNgayCong(5, true, tinhCaDem: true);

                                r2.ngaycong_lt += hp.TinhNgayCong(3, true);
                                r2.tienNC_lt += hp.TinhTienNgayCong(3, true);
                                r2.tienNC_lt += hp.TinhTienNgayCong(3, true, tinhCaDem: true);


                                f = hp.TinhNgayCong(4, true);
                                r2.ngaycong_cn += f;
                                r2.tienNC_cn += hp.TinhTienNgayCong(4, true);
                                r2.tienNC_cn += hp.TinhTienNgayCong(4, true, tinhCaDem: true);
                                ...
                                r2.tgTangCa_Dem += hp.TinhGioTangCa(1, true, tinhCaDem: true);
                                r2.tienTangCa_Dem += hp.TinhTienTangCa(1, true, tinhCaDem: true);

                                f = hp.TinhGioTangCa(2, true);
                                r2.tgTangCa_cn += f;
                                r2.tongTgTangCa_cn_gio += f;
                                r2.tienTangCa_cn += hp.TinhTienTangCa(2, true);
                                r2.tienTangCa_cn += hp.TinhTienTangCa(2, true, tinhCaDem: true);

                                r2.tgTangCa_lt += hp.TinhGioTangCa(3, true);
                                r2.tienTangCa_lt += hp.TinhTienTangCa(3, true, tinhCaDem: true);

                                #endregion

                                #region tinh thưởng bữa tối theo lương cũ.(ca Hành chính SX: 7h30 - 16h30 )
                                var a2 = hp.TinhThuongBuaToi(ds, r2, 10, true);
                                r2.thuongBuaToi += a2;
                                #endregion
                            }
                        }
                        ...
                        r.tongNgayCong = r.ngaycong_bt + r.ngaycong_phep + r.ngaycong_phepNam + r.ngaycong_lt + r.ngayCong_Dem;
                        r.tienNgayCong = r.tienNC_bt + r.tienNC_phep + r.tienNC_phepNam + r.tienNC_lt + r.tienNC_Dem;
                        r.tongThoiGianTangCa = r.tgTangCa_bt + r.tgTangCa_lt + r.tongTgTangCa_cn_gio + r.tgTangCa_Dem;
                        r.tienTangCa = r.tienTangCa_bt + r.tienTangCa_lt + r.tienTangCa_cn + r.tienNC_cn + r.tienTangCa_Dem;

                        r2.tongNgayCong = r2.ngaycong_bt + r2.ngaycong_phep + r2.ngaycong_phepNam + r2.ngaycong_lt + r2.ngayCong_Dem;
                        r2.tienNgayCong = r2.tienNC_bt + r2.tienNC_phep + r2.tienNC_phepNam + r2.tienNC_lt + r2.tienNC_Dem;
                        r2.tongThoiGianTangCa = r2.tgTangCa_bt + r2.tgTangCa_lt + r2.tongTgTangCa_cn_gio + r2.tgTangCa_Dem;
                        r2.tienTangCa = r2.tienTangCa_bt + r2.tienTangCa_lt + r2.tienTangCa_cn + r2.tienNC_cn + r2.tienTangCa_Dem;
                        ...
                        double ngaycong_rounded = (chkLamTron ? i_Round(r.ngaycong_bt + r2.ngaycong_bt + r.ngayCong_Dem + r2.ngayCong_Dem) : (r.ngaycong_bt + r2.ngaycong_bt + r.ngayCong_Dem + r2.ngayCong_Dem)) + (r.ngaycong_lt + r2.ngaycong_lt);
                        // Cũ
                        ...
                        r.tongPhuCapKhac += r.tongThuongCalc + r.thuongBuaToi + r2.thuongBuaToi + r.thuongLamCa + r.ConTho;
                        r.tongLuongTG = r.luongThoiGian + r.ConTho + r.tongThuongCalc + r.thuongBuaToi + r2.thuongBuaToi + r.thuongLamCa;
                        if (r.tongLuongTG >= (r.luongSP + r.tienNC_phep + r.tienNC_phepNam + r2.tienNC_phep + r2.tienNC_phepNam + r.tienNC_lt + r2.tienNC_lt))
                        {
                            r.isLuongSP = false;
                        ...
                        {
                            r.isLuongSP = true;
                            r.tongLuong = r.luongSP + r.ConTho + Convert.ToDouble(r["Calc3"]) + r.thuongLamCa
                                        + r.tienNC_phep + r.tienNC_phepNam + r2.tienNC_phep + r2.tienNC_phepNam + r.tienNC_lt + r2.tienNC_lt;
                            //PC3: Khoản thưởng khác. PC4: Khoản khác (Khoản bù... của các tháng trước)
                            r.tongLuong += Convert.ToDouble(r["PC3"]) + Convert.ToDouble(r["PC4"]);
                        }
                        r2.tongLuongTG = 0;
                        r2.luongThoiGian = 0;
                        r2.tongLuong = 0;
