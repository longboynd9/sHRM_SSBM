            ...
            try
            {
                ...
                foreach (string eID in lstEmp)
                {
                    try
                    {
                        ...
                        r.ngaycong_bt = r.tienNC_bt = r.ngaycong_phep = r.tienNC_phep = r.ngaycong_phepNam = r.tienNC_phepNam = r.ngaycong_lt = r.tienNC_lt = r.ngaycong_cn = r.tienNC_cn = r.tongNgayCong = r.tienNgayCong = r.thuongLamCa = r.thuongBuaToi = 0;
                        ...
                        r2.ngaycong_bt = r2.tienNC_bt = r2.ngaycong_phep = r2.tienNC_phep = r2.ngaycong_phepNam = r2.tienNC_phepNam = r2.ngaycong_lt = r2.tienNC_lt = r2.ngaycong_cn = r2.tienNC_cn = r2.tongNgayCong = r2.tienNgayCong = r2.thuongLamCa = r2.thuongBuaToi = 0;
                        ...
                        for (int i = 1; i < 21; i++)
                        {
                            ...
                            if ((double)r["PC" + i] > 0 || i == 3)
                            {
                                if (i == 3) //PC3: Khoản thưởng khác. + Thêm phụ cấp hàng tháng.
                                {
                                    ...
                                    r["PC3"] = Convert.ToDouble(r["PC3"]) + (a / soNgayCongThucTeTrongThang * (r.ngaycong_bt + r2.ngaycong_bt));
                                }
                        ...
                        double soNgayNghiPhepNam = ds.tbDangKyVangMat.Where(i => i.EmployeeID == e1.EmployeeID && i.lydo == (int)Enums.eLyDoNghi.NghiPhepNam)
                                                    .Sum(i => TinhNgayCongPhep(i));
                        //double ngaycongthucte = 0;
                        //ngaycongthucte = ngaycong_rounded;
                        ...
                        {
                            r.isLuongSP = true;
                            r.tongLuong = r.luongSP + r.tienNC_phep + r.tienNC_phepNam + r2.tienNC_phep + r2.tienNC_phepNam + r.tienNC_lt + r2.tienNC_lt;
                            r.tongLuong += r.tongLuong > 0 ? (r.tongPhuCapKhac + r.tongThuongCalc) : 0; //có lương mới đc + phụ cấp. r.tongThuongCalc: Calc1: Chuyên cần.
                            r.tongLuong += r.ngaycong_cn * 100000;
                        }
                        else
                        {
                            r.isLuongSP = false;
                            // PC2: Tiền con thơ
                            r.tongLuong = r.luongThoiGian + Convert.ToDouble(r["PC2"]) + r.tongThuongCalc;
                        }
                        r2.tongLuongTG = 0;
                        r2.luongThoiGian = 0;
                        r2.tongLuong = 0;
                        //r2.tongLuong = (double)(r2.tongLuong + r2.tongThuongCalc);
                        //r2.tongLuong += r2.tongLuong > 0 ? r2.tongPhuCapKhac : 0; //có lương mới đc + phụ cấp
