            ...
            try
            {
                ...
                foreach (string eID in lstEmp)
                {
                    ...
                    try
                    {
                        ...
                        r.tongTienTangCa_Total = r.tongTienTangCa_Moi + r.tongTienTangCa_Cu + r.tongTienNC_cn_Total;
                        #endregion
                        ...
                        {
                            double ngaycongCN_Round = ((int)r.tongNgayCong_cn_Total) + ((r.tongNgayCong_cn_Total - (int)r.tongNgayCong_cn_Total) > 0 ? 1 : 0);
                            r["PC3"] = Convert.ToDouble(r["PC3"]) + (ngaycongCN_Round * 100000); // Cộng với tiền ngày chủ nhật
                            r.isLuongSP = true;
