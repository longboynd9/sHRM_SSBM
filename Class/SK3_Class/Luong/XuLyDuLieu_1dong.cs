        ...
        public void doAnalyza(DateTime tuNgay, DateTime denNgay, string empID, string depID, int group1ID, bool chkLamTron)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(empID))
                {
                    ...
                    Provider.LoadDataByProc(ds, ds.tbPhuCapCoDinh.TableName, "p_tinhLuong_GetPCCD_WithEmp", new SqlParameter("empID", empID));
                ...
                else if (!string.IsNullOrWhiteSpace(depID))
                {
                    ...
                    Provider.LoadDataByProc(ds, ds.tbPhuCapCoDinh.TableName, "p_tinhLuong_GetPCCD_WithDept", new SqlParameter("maTapThe", depID));
                ...
                else if (group1ID > 0)
                {
                    ...
                    Provider.LoadDataByProc(ds, ds.tbPhuCapCoDinh.TableName, "p_tinhLuong_GetPCCD_WithGroup1", new SqlParameter("group1ID", group1ID));
                ...
                else
                {
                    ...
                    Provider.LoadDataByProc(ds, ds.tbPhuCapCoDinh.TableName, "p_tinhLuong_GetPCCD");
                ...
                lp.OutMessage("Phụ cấp cố định: " + ds.tbPhuCapCoDinh.Rows.Count);
                #endregion
                ...
                foreach (string eID in lstEmp)
                {
                    try
                    {
                        ...
                        r.ngaycong_bt = r.tienNC_bt = r.ngaycong_phep = r.tienNC_phep = r.ngaycong_phepNam = r.tienNC_phepNam = r.ngaycong_lt = r.tienNC_lt = r.ngaycong_cn = r.tienNC_cn = r.tongNgayCong = r.tienNgayCong = r.ngayCong_Dem = r.tienNC_Dem = 0; 
                        ...
                        r2.ngaycong_bt = r2.tienNC_bt = r2.ngaycong_phep = r2.tienNC_phep = r2.ngaycong_phepNam = r2.tienNC_phepNam = r2.ngaycong_lt = r2.tienNC_lt = r2.ngaycong_cn = r2.tienNC_cn = r2.tongNgayCong = r2.tienNgayCong = r2.ngayCong_Dem = r2.tienNC_Dem  = 0;//
