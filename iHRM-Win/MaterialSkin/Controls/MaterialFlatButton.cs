...
namespace MaterialSkin.Controls
{
    public class MaterialFlatButton : Button, IMaterialControl
    {
        ...
        public override string Text
        {
            ...
            {
                base.Text = value;
                textSize = CreateGraphics().MeasureString(value.ToUpper(), SkinManager.Font_SMALL);
                if (AutoSize)
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
			...
			g.DrawString(Text.ToUpper(), SkinManager.Font_SMALL, Enabled ? (Primary ? SkinManager.ColorScheme.PrimaryBrush : SkinManager.GetPrimaryTextBrush()) : SkinManager.GetFlatButtonDisabledTextBrush(), ClientRectangle, new StringFormat { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center });
        }
