...
namespace MaterialSkin.Controls
{
    public class MaterialRadioButton : RadioButton, IMaterialControl
    {
        ...
        {
            int width = boxOffset + 20 + (int)CreateGraphics().MeasureString(Text, SkinManager.Font_SMALL).Width;
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            SizeF stringSize = g.MeasureString(Text, SkinManager.Font_SMALL);
            g.DrawString(Text, SkinManager.Font_SMALL, Enabled ? SkinManager.GetPrimaryTextBrush() : SkinManager.GetDisabledOrHintBrush(), boxOffset + 22, Height / 2 - stringSize.Height / 2);
