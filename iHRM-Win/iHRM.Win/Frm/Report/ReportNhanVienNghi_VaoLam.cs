...
{
    public partial class ReportNhanVienNghi_VaoLam : frmBase
    {
        ...
        public ReportNhanVienNghi_VaoLam()
        {
            InitializeComponent();
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s,ev) => //hàm lấy dữ liệu chạy ngầm
            {
                ...
                if (day != null && todates != null)
                {
                    ...
                    data = logic.GetReportNhanVien(day, todates, chonPhongBan1.SelectedValue, fieldSearch, strGioiTinh);
